...
var array = [];
var abilities = Object.keys(exports.BattleAbilities);
for (var i = 0; i < abilities.length; i++) {
    array.push([abilities[i],exports.BattleAbilities[abilities[i]].name,exports.BattleAbilities[abilities[i]].shortDesc]);
}

var abilityList = {};
for (var i =0; i<array.length; i++) {
    abilityList[array[i][0].toString()] = {"name":array[i][1], "desc":array[i][2]};
}
